        ...
        <div class='col-lg-10'>
            ...
            <div class="border p-2 mb-5">
                ...
                @if(request()->has('redirect'))
                    {{ Form::model($army, array('route' => array('armies.update', $army->id, 'redirect' => request()->get('redirect')), 'method' => 'PUT', 'files' => true)) }}
                @else
                    {{ Form::model($army, array('route' => array('armies.update', $army->id), 'method' => 'PUT', 'files' => true)) }}
                @endif
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-2 mt-3">
                        <img style="height: 120px; margin-right: 8px; margin-bottom: 8px;"
                             src="{{ asset("image/{$army->image}") }}" alt="">
